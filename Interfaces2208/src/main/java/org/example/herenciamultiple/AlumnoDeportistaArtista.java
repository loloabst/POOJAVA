...
public class AlumnoDeportistaArtista extends Alumno implements Deportista,Artista{
    ...
    public AlumnoDeportistaArtista(String nombre, int edad, int numerCuenta, String promedio, int idActivExtra, String deporte, String arte) {
        super(nombre, edad, numerCuenta, promedio);
